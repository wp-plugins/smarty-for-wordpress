<?php
/*
Plugin Name: Smarty Template Plugin
			...
			<h2>Smarty for Wordpress</h2>
				<fieldset class='options'>
					<legend><h2><u>Tips &amp; Techniques</u></h2></legend>
								...
								<ul>
								<li>1. Create the four smarty directories (templates,templates_c,config,cache) under your theme path</li>
								...
								<li>5. If you want to pass a single variable with the template, use [smarty-display tpl=home.tpl name=myVariable value="some value"]
								<li>6. View the page and watch the magic happen!<li>
...
<p>This plugin is based on Smarty 2.6.26 version. When a stable update to Smarty is released, then this plugin will be updated.</p>
